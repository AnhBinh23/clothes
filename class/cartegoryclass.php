...
class cartegory {
    ...
    public function delete_cartegory($cartegory_name, $cartegory_id ){
        $query = "delete tbl_cartegory SET cartegory_name = '$cartegory_name' WHERE cartegory_id = '$cartegory_id' ";
